...
const items = [
  ...
  },
  {
    ...
    body: "Полные коммерческие права. Используйте портреты в LinkedIn, на сайте, в прессе, на визитках — где угодно.",
  },
  {
    icon: RefreshCcw,
    title: "Понравится или вернём деньги",
    body: "Если вы не получите портреты, которыми реально хочется пользоваться, мы бесплатно переобучим модель или вернём деньги полностью.",
  },
  {
    icon: Clock,
