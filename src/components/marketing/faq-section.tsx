...
const faqItems = [
  ...
  },
  {
    ...
    a: `Три тарифа от ${PRICE_LABEL}: набор профессиональных портретов в высоком разрешении (до ${STYLE_COUNT} стилей и до ${HEADSHOT_COUNT}+ фотографий — зависит от тарифа), на почту. Разовый платёж, без подписки и скрытых списаний. Для команд — цена за объём.`,
  },
];
