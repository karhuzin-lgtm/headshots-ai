      ...
      <main className="relative flex-1">
        <div className="relative px-4 pb-8 pt-4 md:px-6 lg:px-10">
          <Button
            asChild
            variant="ghost"
            className="mb-6 h-11 w-full rounded-full text-muted-foreground hover:bg-gray-100 hover:text-foreground sm:mb-0 sm:h-10 sm:w-auto md:absolute md:left-6 md:top-4 md:mb-0 lg:left-10"
          >
            <Link href="/">← Back</Link>
          </Button>
